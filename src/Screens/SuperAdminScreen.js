  ...
  const deleteMachineData = async (machineId, clientId) => {
    try {
      const responseData = await fetch(
        `https://api1.systaldyn.svc:8080/api/v1/deleteMachine/${machineId}`,
        {
          method: "DELETE",
          ...
          <View style={styles.pickerWrapper}>
            <View style={styles.pickerContainer}>
              ...
              >
                <Picker.Item
                  label={
                    isLoadingClients ? "Loading..." : selectedClientOrgName
                  }
                  value={selectedClientId || "17"}
                />
                {clients.map((client) => (
                  <Picker.Item
              ...
              <Ionicons name="chevron-down" style={styles.pickerIcon} />
            </View>
          </View>
        </View>
...
//         <View style={styles.machineIconContainer}>
//           <Image
//             source={require("../../assets/MachineIcon.png")} // Double-check this path
//             style={styles.machineIcon}
//             resizeMode="contain"
//             onError={(error) =>
//               console.log("Image load error:", error.nativeEvent)
//             } // Log errors
//             onLoad={() => console.log("Image loaded successfully")} // Confirm loading
//           />
//         </View>
//         <Text style={styles.machineNameText}>{machine.machine_name}</Text>
//       </View>
...
//         <View style={styles.headerCenter}>
//           <Image
//             source={require("../../assets/Pslogo.png")} // or use a URL: { uri: 'https://example.com/logo.png' }
//             style={styles.logoImage}
//             resizeMode="contain"
//           />
//         </View>
...
//                 enabled={!isLoadingClients}
//                 mode="dropdown"
//                 dropdownIconColor="transparent" // hides default icon
//               >
//                 <Picker.Item
//                   label={
//                     isLoadingClients ? "Loading..." : selectedClientOrgName
...
//   },
//   logoImage: {
//     width: width * 0.13, // 10% of screen width
//     height: width * 0.13, // Keep it square
//     // borderRadius: (width * 0.1) / 2, // Optional: make it circular
//   },
//   menuButton: {
//     padding: width * 0.02,
//   },
...
//     flexDirection: "row",
//     alignItems: "center",
//     paddingRight: width * 0.02, // slightly less padding
//     height: height * 0.045, // decreased height (was 0.06)
//   },
//   picker: {
//     flex: 1,
//     color: "#000000",
//     backgroundColor: "transparent",
//     height: height * 0.045, // match container height
//     paddingVertical: 0, // remove vertical padding
//     paddingLeft: width * 0.02, // some left padding for text
//   },
//   pickerIcon: {
//     fontSize: width * 0.045, // slightly smaller icon
//     color: "#000000",
//     marginLeft: 5,
//   },
...
//     flexDirection: "row",
//     alignItems: "center",
//     backgroundColor: "rgba(128, 232, 232, 0.2)", // Set to fully transparent
//     borderRadius: width * 0.02,
//     padding: width * 0.02,
//     marginBottom: height * 0.01,
//     borderWidth: 1,
...
//     width: "90%",
//     height: "90%",
//     // tintColor removed for debugging
//   },
//   machineNameText: {
//     fontSize: width * 0.04,
//     color: "#FFFFFF",
...
//     height: height * 0.08, // Fixed height for header
//   },
//   logoImage: {
//     width: width * 0.12,
//     height: width * 0.12,
...
//     paddingVertical: height * 0.015,
//     alignItems: "center",
//     height: height * 0.15, // Fixed height for title section
//   },
//   mainTitle: {
//     fontSize: width * 0.06 > 24 ? 24 : width * 0.06,
//     fontWeight: "bold",
//     color: "#FFFFFF",
//     textAlign: "center",
//     marginBottom: height * 0.015,
...
//   },
//   machinesList: {
//     flex: 1, // Takes remaining space in the section
//   },
//   machinesListContent: {
//     paddingBottom: height * 0.01,
//   },
